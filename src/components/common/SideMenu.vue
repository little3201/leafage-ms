                ...
                <a href="" class="flex items-center mt-2">
                  <div class="w-8 h-8 image-fit">
                    <img
                      alt="Midone Tailwind HTML Admin Template"
                      class="rounded-full"
                      src="/src/assets/images/profile-13.jpg"
                    />
                  </div>
                ...
                <a href="" class="flex items-center mt-2">
                  <div class="w-8 h-8 image-fit">
                    <img
                      alt="Midone Tailwind HTML Admin Template"
                      class="rounded-full"
                      src="/src/assets/images/profile-14.jpg"
                    />
                  </div>
            ...
            <div class="intro-y box p-5 mt-12 sm:mt-5">
              <div class="flex flex-col xl:flex-row xl:items-center">
                ...
                <div class="dropdown relative xl:ml-auto mt-5 xl:mt-0">
                  ...
                  <div
                    class="dropdown-box mt-10 absolute w-40 top-0 xl:right-0 z-20"
                  >
                    <div
          ...
          <div class="col-span-12 xl:col-span-8 mt-6">
            ...
            <div class="intro-y box p-5 mt-12 sm:mt-5">
              ...
              <div
                ...
                data-sources="//src/assets/json/location.json"
              ></div>
            </div>
          </div>
          <!-- END: Official Store -->
              ...
              <div class="intro-y">
                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                  ...
                  >
                    <img
                      alt="Midone Tailwind HTML Admin Template"
                      src="/src/assets/images/profile-10.jpg"
                    />
                  </div>
                  <div class="ml-4 mr-auto">
                ...
                <div class="intro-x relative flex items-center mb-3">
                  <div class="report-timeline__image">
                    ...
                    >
                      <img
                        alt="Midone Tailwind HTML Admin Template"
                        src="/src/assets/images/profile-9.jpg"
                      />
                    </div>
                  </div>
                ...
                <div class="intro-x relative flex items-center mb-3">
                  ...
                  <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                    ...
                    <div class="text-gray-600 mt-1">
                      Has changed
                      <a class="text-theme-1" href="">Sony Master Series A9G</a>
                ...
                <div class="intro-x box">
                  <div class="p-5">
                    ...
                    <div class="grid grid-cols-7 gap-4 mt-5 text-center">
                      ...
                      <div class="py-1 bg-theme-1 text-white rounded relative">
                        8
                      </div>
