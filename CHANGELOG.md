<p align="center">
  <a href="https://console.leafage.top" target="_blank">
    <img alt="Leafage Logo" src="src/assets/logo.svg" width="200" height="200"/>
  </a>
</p>
...
2023-04-18:
  1. 重构：修改接口对象属性，添加Drawer组件，新增/编辑不使用Modal，表格头部添加搜素框;
  2. 移除小屏幕菜单组件，小屏幕不展示数据，提示使用大屏幕；
  3. 更新chart.js封装；
  4. 替换图标库，使用heroicons；
  5. 更新接口返回数据结构，mock数据修改；

2022-04-21:
  1. 优化 Modal.vue 小屏无法居中的问题;
  2. 移除 Preview.vue, Tree.vue 复用 Modal.vue组件；
...
2021-10-15:
  1. Modal 样式优化, Posts 中 tags 显示优化；
  2. 文件目录结构优化；
...
2021-08-10:
  1. 修改新增时，modal打开同时请求数据未进行判断空参数导致输入问题；
...
2021-05-15:
  1. Modal.vue重构，Confirm.vue, Tree.vue复用Model组件，同步更新使用;
  2. 动态渲染菜单，权限树；
