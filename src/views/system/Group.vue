      ...
      <table class="table table-report sm:mt-2">
        <thead>
          <tr class="uppercase">
            ...
            <th class="text-center whitespace-no-wrap">Superior</th>
            <th class="text-center whitespace-no-wrap">Principal</th>
            <th class="text-center whitespace-no-wrap">User Count</th>
        ...
        <tbody>
          <tr class="intro-x" v-for="(data, index) in datas" :key="index">
            ...
            <td class="text-center" v-text="data.superior"></td>
            <td class="text-center" v-text="data.principal"></td>
            <td class="text-center" v-text="Math.floor(Math.random()*10)"></td>
