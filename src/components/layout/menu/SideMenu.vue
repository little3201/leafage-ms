    ...
    <nav class="side-nav">
      ...
      <ul>
        <li v-for="(side, index) in menus" :key="index">
          <a
            href="#"
            :class="side.name == openPage ? 'side-menu' : 'side-menu side-menu--active'"
          >
            <div
          ...
          <ul v-if="side.subs && isOpen" class="side-menu__sub-open">
...
.side-nav {
    width: 230px;
    @apply pr-5 pb-16 overflow-x-hidden;
    ...
    .side-menu {
        height: 50px;
        @apply flex items-center pl-5 text-white mb-1 relative rounded-full;
        .side-menu__title {
            @apply w-full ml-3 flex items-center;
            .side-menu__sub-icon {
                @apply transition ease-in duration-100 w-4 h-4 ml-auto mr-5;
                @media (max-width: theme('screens.xl')) {
                    @apply hidden;
                }
            }
    ...
    > ul {
        ...
        ul {
            ...
            @apply hidden bg-theme-28 rounded-md;
            &.side-menu__sub-open {
                @apply block;
            }
            ...
            ul {
                @apply hidden bg-theme-29 rounded-md;
            }
        }
        & > li {
            & > .side-menu {
