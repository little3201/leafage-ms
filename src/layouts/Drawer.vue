    ...
    <div class="flex justify-between mb-2">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 311.983 311.929">
          <g data-name="Icon ionic-ios-apps" transform="translate(-4.494 -4.496)">
            <path
              ...
              transform="translate(0.07 0)" fill="#b5c8ff" />
            <g transform="translate(4.493 135.941)">
              <path
                ...
                transform="translate(-4.423 60.176)" fill="#fff" />
              <path
      ...
      <button type="button" @click="isShow = !isShow" class="outline-none">
        <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
          stroke-linecap="round" stroke-linejoin="round" class="text-white transform -rotate-90">
          <use :xlink:href="'/svg/feather-sprite.svg#' + 'bar-chart-2'" />
        </svg>
      </button>
    </div>
    <div class="mt-2 mb-4 h-px bg-gray-200 bg-opacity-30"></div>
    <div v-show="isShow" class="fixed inset-0 overflow-hidden max-w-xs z-10" aria-labelledby="slide-over-title"
