<template>
  <q-layout style="overflow: hidden">
    <q-page-container class="row justify-center items-center relative-position window-height overflow-hidden"
      :style="{ background: $q.dark.isActive ? 'black' : '#e3f4fa' }">
      <div class="fixed-top-left absolute-top-left q-pa-md">
        <q-img alt="logo" src="https://cdn.leafage.top/logo-only.png" style="width: 64px; height: 64px;" />
      </div>
      <div class="z-top fixed-top-right absolute-top-right">
                  ...
                  <q-card-section>
                    <q-card-section>
                      <div class="text-center">
                        <q-img alt="logo" src="https://cdn.leafage.top/logo.png"
