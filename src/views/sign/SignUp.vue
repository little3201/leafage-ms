<template>
  <Sign>
    ...
    <form @submit.prevent class="mx-auto">
      <div class="mt-6">
        <input type="email" v-model="formData.email" class="block border-gray-300 rounded-md w-full my-6 shadow-sm"
        ...
        <input type="password" v-model.trim="confirmPassword"
          class="block border-gray-300 rounded-md w-full my-6 shadow-sm" placeholder="Confirm Password" required
          autocomplete="off" />
      </div>
      <div class="flex items-center text-gray-700">
        <input type="checkbox" v-model="formData.agree" class="rounded border-gray-300 shadow-sm mr-2" />
    ...
    <div class="my-6 text-center xl:text-left">
      ...
      <RouterLink class="text-blue-600" to="/signin">Sign in</RouterLink>
    </div>
  </Sign>
</template>
